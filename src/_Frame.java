        ...
        public void paint(Graphics oldg) {
            ...
            for(int i = 0; i < alloy.getHeight(); i++) {
                for(int j = 0; j < alloy.getWidth(); j++) {
                    ...
                    //g.setColor(colorSet[(int)(thread.alloy[i][j])]);//absolutly
                    g.fillRect(j*size, i*size, size, size);
                }
            }
            oldg.drawImage(img_buffer, (_Frame.this.getWidth()-img_buffer.getWidth(this))/2, (_Frame.this.getHeight()-img_buffer.getHeight(this))/2-20, this);
        }
